...
export default {
  ...
  mutations: {
    SET_DATA_SCALE_SFSS(state, scoreHistorySfss) {
      state.scoreHistorySfssGraphData = scoreHistorySfss;
    },
    SET_PARTS_SELECTED(state, data) {
      state.partsScaleSelectedSfss = data;
    },
  ...
  actions: {
    async getScoreScaleSfss({ commit, rootState }, scaleId, nameScale) {
      ...
      commit("SET_DATA_SCALE_SFSS", {data: scores });
